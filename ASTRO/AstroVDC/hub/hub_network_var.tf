...
variable "Hub-IntWAF-NSG-Rules" {
  ...
  default = {
    #"rule1" = [1000, "Inbound", "Allow", "TCP", "*", "*", "*", "*"]
    "Allow_Inbound_Int_DMZ" = [1000, "Inbound", "Allow", "TCP", " 65200-65535", "*", "*", "*"]
  }
}
...
variable "Hub-Net01-NSG-Rules" {
  default = {
    "port_3389" = [1000, "Inbound", "Allow", "*","*","3389","*","10.3.1.4"]
    #"rule1" = [1000, "Inbound", "Allow", "TCP", "*", "*", "*", "*"]
...
variable "Hub-WAD-Net01-NSG" {
  default = "Hub-WAD-Net01-NSG"
}

variable "Hub-WAD-Net01-NSG-Rules" {
  default = {
    #"rule1" = [1000, "Inbound", "Allow", "TCP", "*", "*", "*", "*"]
    #"rule2" = [1001, "Outbound", "Allow", "TCP", "*", "*", "*", "*"]
    #"rule3" = [1002, "Outbound", "Allow", "TCP", "*", "*", "*", "*"]
...
variable "Hub-Ext-DMZ-APPGW01" {
  default = {
    ...
    routing_rules = {
      ...
      "default_rule" = ["Basic", "default_pool", "default_be_http_setting", "default_listener", "Http", 80, ""]
    }
...
variable "Hub-Int-DMZ-APPGW01-PIP01" {
  default = {
