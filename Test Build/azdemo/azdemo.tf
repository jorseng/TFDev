...
# resource "azurerm_virtual_network" "vnet-dmz" {
#     name = "${local.vnet-dmz}"
#     location = "${azurerm_resource_group.demorg.location}"
#     resource_group_name = "${azurerm_resource_group.demorg.name}"
...
#     name = "${local.vnet-dmz-subnet-appgw}"
#     resource_group_name = "${azurerm_resource_group.demorg.name}"
#     virtual_network_name = "${azurerm_virtual_network.vnet-dmz.name}"
...
# resource "azurerm_network_interface" "dbserver-nic" {
#     name = "${local.dbserver}-nic"
#     location = "${azurerm_resource_group.demorg.location}"
#     resource_group_name = "${azurerm_resource_group.demorg.name}"

#     ip_configuration {
#         name = "${local.dbserver}-ipconfig"
